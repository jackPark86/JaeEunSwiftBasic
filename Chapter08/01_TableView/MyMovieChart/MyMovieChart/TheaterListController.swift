...
//  MyMovieChart
//
//  Created by icoinnet on 2021/07/11.
//
...
class TheaterListController: UITableViewController {
    ...
    do {
        ...
        let stringdata = try NSString(contentsOf: urlObj!, encoding: 0x80_000_422) // EUC-KR로 인코딩
        ...
        do{
            ...
            showAlert(title: "실패", message: "데이터 분석이 실패하였습니다.")
        ...
        showAlert(title: "실패", message: "데이터를 불러오는데 실패하였습니다.")
    }//end of try ~ catch
        
        
    }//end of CallTheaterAPI
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //재사용 큐로부터 tCell 식별자에 맞는 셀 객체를 전달받ㅇ므
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if(segue.identifier == "segue_map"){
            ...
            (segue.destination as? TheaterViweController)?.param = data
            
        }
    }//end of prepare
}//end of class TheaterListController
